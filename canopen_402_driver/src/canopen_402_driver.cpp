...
void MotionControllerDriver::handle_init(const std_srvs::srv::Trigger::Request::SharedPtr request,
...
void MotionControllerDriver::handle_recover(const std_srvs::srv::Trigger::Request::SharedPtr request,
                                            std_srvs::srv::Trigger::Response::SharedPtr response)
{
  if (active.load())
  {
...
void MotionControllerDriver::handle_halt(const std_srvs::srv::Trigger::Request::SharedPtr request,
                                         std_srvs::srv::Trigger::Response::SharedPtr response)
{
  if (active.load())
  {
...
void MotionControllerDriver::handle_set_mode_position(const std_srvs::srv::Trigger::Request::SharedPtr request,
                                                      std_srvs::srv::Trigger::Response::SharedPtr response)
{
  if (active.load())
  {
...
void MotionControllerDriver::handle_set_mode_velocity(const std_srvs::srv::Trigger::Request::SharedPtr request,
                                                      std_srvs::srv::Trigger::Response::SharedPtr response)
{
  if (active.load())
  {
...
void MotionControllerDriver::handle_set_mode_cyclic_position(const std_srvs::srv::Trigger::Request::SharedPtr request,
                                                             std_srvs::srv::Trigger::Response::SharedPtr response)
{
  if (active.load())
  {
...
void MotionControllerDriver::handle_set_mode_cyclic_velocity(const std_srvs::srv::Trigger::Request::SharedPtr request,
                                                             std_srvs::srv::Trigger::Response::SharedPtr response)
{
  if (active.load())
  {
...
void MotionControllerDriver::handle_set_mode_torque(const std_srvs::srv::Trigger::Request::SharedPtr request,
                                                    std_srvs::srv::Trigger::Response::SharedPtr response)
{
  if (active.load())
  {
...
void MotionControllerDriver::register_services()
{
  ...
  handle_init_service =
      this->create_service<std_srvs::srv::Trigger>(std::string(this->get_name()).append("/init").c_str(),
                                                   std::bind(&MotionControllerDriver::handle_init, this, _1, _2));

  handle_halt_service =
      this->create_service<std_srvs::srv::Trigger>(std::string(this->get_name()).append("/halt").c_str(),
                                                   std::bind(&MotionControllerDriver::handle_halt, this, _1, _2));

  handle_recover_service =
      this->create_service<std_srvs::srv::Trigger>(std::string(this->get_name()).append("/recover").c_str(),
...
void MotionControllerDriver::init(ev::Executor& exec, canopen::AsyncMaster& master, uint8_t node_id,
                                  std::shared_ptr<ros2_canopen::ConfigurationManager> config) noexcept
{
  ...
  if (!period.has_value())
  {
    RCLCPP_INFO(this->get_logger(), "INFO: Bus Configuration does not set period for %s", this->get_name());
  }
  else
  {
