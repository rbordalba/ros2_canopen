...
CallbackReturn CanopenProxyController::on_init()
{
...
CallbackReturn CanopenProxyController::on_configure(
...
CallbackReturn CanopenProxyController::on_activate(
  const rclcpp_lifecycle::State & /*previous_state*/)
{
...
CallbackReturn CanopenProxyController::on_deactivate(
  const rclcpp_lifecycle::State & /*previous_state*/)
{
